...
public final class SimpleExample {
    ...
    static final double VEHICLE_SPEED_KMH = 150d;
    ...
    static class Driver implements MovingRoadUser, TickListener {
        ...
        public void initRoadUser(RoadModel model) {
            ...
            positionGoal = roadModel.getRandomPosition(this.rnd);
        }
        ...
        public void tick(TimeLapse timeLapse) {
            ...
            roadModel.moveTo(this, positionGoal, timeLapse);

            if(roadModel.getPosition(this).equals(positionGoal)) {
                this.positionGoal = roadModel.getRandomPosition(rnd);
            }
        }
